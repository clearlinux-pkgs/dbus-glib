...
%patch -P 1 -p1
pushd ..
cp -a dbus-glib-0.112 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707074585
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libdbus-glib-1.so.2.3.5
/usr/lib64/libdbus-glib-1.so.2
/usr/lib64/libdbus-glib-1.so.2.3.5

%files libexec
%defattr(-,root,root,-)
/V3/usr/libexec/dbus-bash-completion-helper
